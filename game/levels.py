...
def get_level_specs() -> Dict[int, LevelSpec]:
    ...
    level_two = LevelSpec(
        ...
        spawn_point=(120, 200),
        platforms=[
            PlatformSpec(1300, 20, 2600, 40, arcade.color.DIM_GRAY),
            PlatformSpec(420, 180, 140, 24, arcade.color.LIGHT_STEEL_BLUE),
            PlatformSpec(700, 260, 140, 24, arcade.color.LIGHT_STEEL_BLUE),
            PlatformSpec(980, 340, 140, 24, arcade.color.LIGHT_STEEL_BLUE),
            PlatformSpec(1260, 260, 140, 24, arcade.color.LIGHT_STEEL_BLUE),
            PlatformSpec(1540, 180, 140, 24, arcade.color.LIGHT_STEEL_BLUE),
        ],
        coins=[
            CoinSpec(420, 220),
            CoinSpec(700, 300),
