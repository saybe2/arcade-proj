...
- Работают Level 1 и Level 2 (Level 1 на PhysicsEnginePlatformer, Level 2 на Pymunk).
- Есть враги, монеты, шипы, победа/поражение и респавн в уровне.
- Реализовано сохранение прогресса (рекорды, пройденные уровни, время).
- Уровни собираются через класс данных (LevelSpec/LevelBuilder).
